    ...
    <section class="biblioteca" id="biblioteca">
        <div class="biblioteca-cabecalho">
            ...
            <div class="biblioteca-controles">
                <button class="catalogo-seta catalogo-anterior" type="button" aria-label="Jogos anteriores">‹</button>
                <button class="catalogo-seta catalogo-proximo" type="button" aria-label="Próximos jogos">›</button>
            </div>
        </div>
        ...
        <?php if (empty($catalogo)): ?>
            <div class="catalogo-vazio">Nenhum jogo disponível no catálogo.</div>
        <?php endif; ?>
    </section>
</main>
